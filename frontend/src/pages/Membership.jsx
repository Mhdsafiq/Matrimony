...
const plans = [
    {
        ...
        features: [
            ...
            { text: 'WhatsApp contact sharing', included: false },
    ...
    },
    {
        ...
        features: [
            ...
            { text: 'Chat with matches', included: true },
            { text: 'WhatsApp contact sharing', included: true },
...
const compareFeatures = [
    ...
    { label: 'Chat with matches', bronze: false, silver: true, gold: true, diamond: true },
    { label: 'Profile match score', bronze: false, silver: false, gold: true, diamond: true },
    { label: 'WhatsApp sharing', bronze: false, silver: false, gold: true, diamond: true },
